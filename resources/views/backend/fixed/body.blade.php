                            ...
                            <li class="list-group-item todo-item" data-role="task">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label w-100 mb-0 todo-label"
                                        ...
                                        <span class="badge rounded-pill bg-warning float-end">2
                                            weeks</span>
                                    </label>
                                </div>
                                <div class="item-date">26 jun 2021</div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="progress">
                            <div class="progress-bar progress-bar-striped" role="progressbar"
                                style="width: 81%" aria-valuenow="10" aria-valuemin="0"
            ...
            <div class="card">
                ...
                <ul class="list-style-none">
                    ...
                    <li class="d-flex no-block card-body border-top">
                        ...
                        <div>
                            <a href="#" class="mb-0 font-medium p-0">Maruti is a Responsive Admin
                                theme</a>
